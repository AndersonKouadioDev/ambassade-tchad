...
export const ProfilPassword = ({t, handlePasswordSubmit, PasswordField, showPassword, setShowPassword, setActiveTab}: {
    ...
    <div>
        <div className="text-base text-gray-900  mb-2 font-semibold">{t('champsObligatoires')}</div>
        ...
        <form className="flex flex-col gap-8 items-center" onSubmit={(e) => {
            ...
            <div className="w-full max-w-2xl flex flex-row gap-6">
                <div className="flex-1">
                    <label
                        className="block text-gray-900  font-semibold mb-1">{t('motDePasseActuel')} *</label>
            ...
            <div className="w-full max-w-2xl flex flex-row gap-6">
                <div className="flex-1">
                    <label
                        className="block text-gray-900  font-semibold mb-1">{t('nouveauMotDePasse')} *</label>
                ...
                <div className="flex-1">
                    <label
                        className="block text-gray-900  font-semibold mb-1">{t('confirmerMotDePasse')} *</label>
