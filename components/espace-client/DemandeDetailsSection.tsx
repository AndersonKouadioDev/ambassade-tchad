...
export default function DemandeDetailsSection({ ticket }: { ticket: string }) {
  ...
  const translateJustificationDocumentType = (value: string) => {
    return (
      DocumentJustificationTypeLabels[value as DocumentJustificationType] ||
      value
    );
  };
      ...
      case "VISA":
        if (demande.visaDetails) {
          return [
            ...
            [
              "Genre",
              translateEnum(demande.visaDetails.personGender, "Gender"),
            ],
            ["Nationalité", demande.visaDetails.personNationality],
            [
              "Date de naissance",
              new Date(demande.visaDetails.personBirthDate).toLocaleDateString(
                "fr-FR"
              ),
            ],
            ...
            [
              "État civil",
              translateEnum(
                demande.visaDetails.personMaritalStatus,
                "MaritalStatus"
              ),
            ],
            [
              "Type de passeport",
              translateEnum(demande.visaDetails.passportType, "PassportType"),
            ],
            ...
            [
              "Date de délivrance",
              new Date(
                demande.visaDetails.passportIssueDate
            ...
            [
              "Type de visa",
              translateEnum(demande.visaDetails.visaType, "VisaType"),
            ],
        ...
        if (demande.laissezPasserDetails) {
          const fields = [
            ...
            [
              "Date de naissance",
              new Date(
                demande.laissezPasserDetails.personBirthDate
              ).toLocaleDateString("fr-FR"),
            ],
            [
              "Lieu de naissance",
              demande.laissezPasserDetails.personBirthPlace,
            ],
            ...
            [
              "Accompagné",
              demande.laissezPasserDetails.accompanied ? "Oui" : "Non",
            ],
          ];
          // Affichage des accompagnateurs si accompagné
          if (
            demande.laissezPasserDetails.accompanied &&
            demande.laissezPasserDetails.accompaniers?.length
          ) {
            fields.push([
              "Accompagnateurs",
              demande.laissezPasserDetails.accompaniers
                .map(
                  (acc: AccompagnateurDTO) =>
                    `${acc.firstName} ${acc.lastName} (${new Date(
                      acc.birthDate
                    ).toLocaleDateString("fr-FR")}, ${acc.nationality})`
                )
                .join(" ; "),
            ]);
          }
        ...
        if (demande.consularCardDetails) {
          return [
            ...
            [
              "Date de naissance",
              new Date(
                demande.consularCardDetails.personBirthDate
              ).toLocaleDateString("fr-FR"),
            ],
            ...
            [
              ...
              demande.consularCardDetails.personAddressInOriginCountry,
            ],
            ...
            [
              ...
              translateJustificationDocumentType(
                demande.consularCardDetails.justificationDocumentType || ""
              ),
            ],
            [
              "Numéro de pièce",
              demande.consularCardDetails.justificationDocumentNumber,
            ],
            [
              "Date d'expiration de la carte",
              demande.consularCardDetails.cardExpirationDate
                ? new Date(
                    demande.consularCardDetails.cardExpirationDate
                  ).toLocaleDateString("fr-FR")
                : "",
      ...
      case "POWER_OF_ATTORNEY":
        if (demande.powerOfAttorneyDetails) {
          return [
            ...
            [
              "Prénom du demandeur",
              demande.powerOfAttorneyDetails.agentFirstName,
            ],
            ["Nom du demandeur", demande.powerOfAttorneyDetails.agentLastName],
            [
              "Type de pièce du demandeur",
              demande.powerOfAttorneyDetails.agentJustificationDocumentType,
            ],
            [
              "Numéro pièce du demandeur",
              demande.powerOfAttorneyDetails.agentIdDocumentNumber,
            ],
            [
              "Adresse du demandeur",
              demande.powerOfAttorneyDetails.agentAddress,
            ],
            [
              "Prénom du principal",
              demande.powerOfAttorneyDetails.principalFirstName,
            ],
            [
              "Nom du principal",
              demande.powerOfAttorneyDetails.principalLastName,
            ],
            [
              "Type de pièce principal",
              demande.powerOfAttorneyDetails.principalJustificationDocumentType,
            ],
            [
              "Numéro pièce principal",
              demande.powerOfAttorneyDetails.principalIdDocumentNumber,
            ],
            [
              "Adresse du principal",
              demande.powerOfAttorneyDetails.principalAddress,
            ],
        ...
        if (demande.birthActDetails) {
          return [
            ...
            [
              "Date de naissance",
              new Date(
                demande.birthActDetails.personBirthDate
              ).toLocaleDateString("fr-FR"),
            ],
        ...
        if (demande.deathActDetails) {
          return [
            ...
            [
              "Date de naissance",
              new Date(
                demande.deathActDetails.deceasedBirthDate
              ).toLocaleDateString("fr-FR"),
            ],
            [
              "Date de décès",
              new Date(
                demande.deathActDetails.deceasedDeathDate
              ).toLocaleDateString("fr-FR"),
            ],
      ...
      case "MARRIAGE_CAPACITY_ACT":
        if (demande.marriageCapacityActDetails) {
          return [
            ...
            [
              "Prénom du mari",
              demande.marriageCapacityActDetails.husbandFirstName,
            ],
            ["Nom du mari", demande.marriageCapacityActDetails.husbandLastName],
            [
              "Date de naissance mari",
              new Date(
                demande.marriageCapacityActDetails.husbandBirthDate
              ).toLocaleDateString("fr-FR"),
            ],
            [
              "Lieu de naissance mari",
              demande.marriageCapacityActDetails.husbandBirthPlace,
            ],
            [
              "Nationalité mari",
              demande.marriageCapacityActDetails.husbandNationality,
            ],
            [
              "Domicile mari",
              demande.marriageCapacityActDetails.husbandDomicile,
            ],
            [
              "Prénom de l'épouse",
              demande.marriageCapacityActDetails.wifeFirstName,
            ],
            [
              "Nom de l'épouse",
              demande.marriageCapacityActDetails.wifeLastName,
            ],
            [
              "Date de naissance épouse",
              new Date(
                demande.marriageCapacityActDetails.wifeBirthDate
              ).toLocaleDateString("fr-FR"),
            ],
            [
              "Lieu de naissance épouse",
              demande.marriageCapacityActDetails.wifeBirthPlace,
            ],
            [
              "Nationalité épouse",
              demande.marriageCapacityActDetails.wifeNationality,
            ],
            [
              "Domicile épouse",
              demande.marriageCapacityActDetails.wifeDomicile,
            ],
          ];
        }
        break;
      case "NATIONALITY_CERTIFICATE":
        if (demande.nationalityCertificateDetails) {
          return [
            ...
            [
              "Prénom",
              demande.nationalityCertificateDetails.applicantFirstName,
            ],
            ["Nom", demande.nationalityCertificateDetails.applicantLastName],
            [
              "Date de naissance",
              new Date(
                demande.nationalityCertificateDetails.applicantBirthDate
              ).toLocaleDateString("fr-FR"),
            ],
            [
              "Lieu de naissance",
              demande.nationalityCertificateDetails.applicantBirthPlace,
            ],
            [
              "Nationalité",
              demande.nationalityCertificateDetails.applicantNationality,
            ],
            [
              "Prénom parent origine",
              demande.nationalityCertificateDetails
                .originCountryParentFirstName,
            ],
            [
              "Nom parent origine",
              demande.nationalityCertificateDetails.originCountryParentLastName,
            ],
            [
              "Lien parenté",
              translateEnum(
    ...
    return (
      <div className="bg-white rounded-lg border border-gray-200 p-8 shadow-md">
        <div className="text-center py-12 text-gray-500">
          ...
          <p className="mt-2">
            Veuillez sélectionner une demande pour afficher les détails
          </p>
        </div>
      </div>
    );
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-md overflow-hidden printable">
          ...
          <div className="flex justify-center items-center flex-col py-4 print:py-2">
            ...
            <div className="text-center">
              <div className="font-bold text-lg md:text-2xl text-gray-900 print:text-black">
                Ambassade de la République du Tchad
              </div>
              <div className="text-sm md:text-base text-gray-700 print:text-black">
                Section Consulaire
              </div>
              <div className="text-xs md:text-sm text-gray-600 print:text-black mt-1">
                Abidjan, cocody 2 Plateaux vallons, Côte d&apos;Ivoire
                <br />
                Tél : +225 01245578485 &nbsp;|&nbsp; Email :
                contact@ambassade-tchad.com
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-blue-100 mt-1">
                  {translateServiceType(demande.serviceType)} • N°{" "}
