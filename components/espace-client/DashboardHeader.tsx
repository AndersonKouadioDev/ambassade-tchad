...
export default function DashboardHeader() {
  ...
  return (
    <div className="w-full bg-gray-50  rounded-xl flex flex-col lg:flex-row items-center lg:items-start justify-center lg:justify-between px-4 py-4 lg:px-8 lg:py-6 gap-4 lg:gap-8">
      <div className="flex-1 flex flex-col items-center max-w-md lg:max-w-4xl mx-auto">
        <div className="text-sm lg:text-xl font-bold text-blue-800 mb-4 text-center">
          {t('bienvenue')} <span className="text-md text-orange-600 italic font-bold uppercase">{userName}</span>
        </div>

        {/* Étapes à suivre */}
        <div className="w-full bg-white  rounded-2xl shadow-lg p-6 lg:p-8">
        ...
        <div className="mt-8 bg-gray-50  rounded-xl p-6 w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div className="flex items-center">
              ...
              <span className="text-gray-700">{t('info1')}</span>
            </div>
            <div className="flex items-center">
              <svg className="w-5 h-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              </svg>
              <span className="text-gray-700">{t('info2')}</span>
            </div>
            <div className="flex items-center">
              <svg className="w-5 h-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              </svg>
              <span className="text-gray-700">{t('info3')}</span>
            </div>
            <div className="flex items-center">
              <svg className="w-5 h-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              </svg>
              <span className="text-gray-700">{t('info4')}</span>
            </div>
          </div>
        </div>
      </div>
